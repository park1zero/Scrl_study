...
def step_simple_driver(driver_state: SimpleDriverState, vehicle_state, obstacle: Obstacle, params: SimpleDriverParams, dt: float, vx: float | None = None) -> Tuple[float, Dict[str, float]]:
    snapshot = {
        'x': vehicle_state.x,
        'y': vehicle_state.y,
